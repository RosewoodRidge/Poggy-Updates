--[[===========================================================================
    ...
    So a complete, working store is three lines:
        ...
        { type = "generalstore", name = "Valentine General Store",
          coords = vec3(-325.42, 797.53, 117.88), heading = 88.0,
      npc = false },
...
Config.StoreTypes = {
    generalstore = {
        ...
        sell       = "GeneralStore",
        buy        = "GeneralStore",
        blipSprite = Config.BlipSprites.shop,
        npcModel   = false,
    },
    gunsmith = {
        label      = "Gunsmith",
    ...
    outfitter = {
        ...
        sell       = "Camping",
        buy        = false,
        blipSprite = Config.BlipSprites.outfitter,
...
--             blipSprite   override the type's blip
--             sell / buy   override the type's item lists
--             npc          false for no clerk, or a table:
--                            { model    = "...",
--                              coords   = vec3(x, y, z),   -- where the CLERK stands
--                              heading  = 0.0,
--                              grounded = false }
...
Config.Stores = {
    ...
    { type = "generalstore", name = "Rhodes General Store",
      coords = vec3(1326.83, -1288.95, 77.02),  heading = 300.0,
      npc = false },

    { type = "generalstore", name = "Saint Denis General Store",
      coords = vec3(2833.00, -1313.53, 46.76),  heading = 180.0,
      npc = false },

    { type = "generalstore", name = "Blackwater General Store",
      coords = vec3(-787.86, -1326.86, 43.88),  heading = 90.0,
      npc = false },

    { type = "generalstore", name = "Strawberry General Store",
      coords = vec3(-1795.34, -385.79, 160.33), heading = 130.0,
      npc = false },

    { type = "generalstore", name = "Armadillo General Store",
      coords = vec3(-3684.88, -2629.25, -13.43), heading = 0.0,
      npc = false },

    { type = "generalstore", name = "Annesburg General Store",
      coords = vec3(2929.11, 1369.65, 45.19),   heading = 220.0,
      npc = false },

    { type = "generalstore", name = "Tumbleweed General Store",
      coords = vec3(-5491.15, -2937.72, -0.40), heading = 255.0,
      npc = false },

    { type = "generalstore", name = "Van Horn General Store",
      coords = vec3(3023.78, 567.37, 44.71),    heading = 180.0,
      npc = false },

    -- ─── GUNSMITHS ─────────────────────────────────────────────────────────
    { type = "gunsmith", name = "Valentine Gunsmith",
      coords = vec3(-279.54, 783.37, 119.50),   heading = 180.0,
      npc = false },

    { type = "gunsmith", name = "Rhodes Gunsmith",
      coords = vec3(1320.61, -1325.83, 77.88),  heading = 0.0,
      npc = false },

    { type = "gunsmith", name = "Saint Denis Gunsmith",
      coords = vec3(2717.28, -1280.14, 49.63),  heading = 90.0,
      npc = false },

    { type = "gunsmith", name = "Blackwater Gunsmith",
      coords = vec3(-833.12, -1264.84, 43.58),  heading = 270.0,
      npc = false },

    { type = "gunsmith", name = "Armadillo Gunsmith",
      coords = vec3(-3681.69, -2627.50, -13.43), heading = 0.0,
      npc = false },

    { type = "gunsmith", name = "Annesburg Gunsmith",
      coords = vec3(2945.56, 1316.20, 44.82),   heading = 180.0,
      npc = false },

    { type = "gunsmith", name = "Tumbleweed Gunsmith",
      coords = vec3(-5508.50, -2961.94, -0.64), heading = 90.0,
      npc = false },

    -- ─── BUTCHERS  (buy pelts and meat from players) ───────────────────────
    { type = "butcher", name = "Valentine Butcher",
      coords = vec3(-341.15, 767.17, 116.79),   heading = 186.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(-339.23, 767.64, 115.64),
              heading = 92.6, grounded = false } },

    { type = "butcher", name = "Rhodes Butcher",
      coords = vec3(1296.43, -1279.37, 75.91),  heading = 147.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(1297.35, -1277.56, 74.95),
              heading = 147.4, grounded = false } },

    { type = "butcher", name = "Saint Denis Butcher",
      coords = vec3(2817.85, -1329.86, 46.59),  heading = 48.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(2819.21, -1331.18, 45.58),
              heading = 47.5, grounded = false } },

    { type = "butcher", name = "Blackwater Butcher",
      coords = vec3(-761.25, -1285.75, 43.70),  heading = 271.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(-763.12, -1284.39, 42.70),
              heading = 271.4, grounded = false } },

    { type = "butcher", name = "Strawberry Butcher",
      coords = vec3(-1752.91, -396.49, 156.15), heading = 186.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(-1753.20, -392.96, 155.31),
              heading = 185.7, grounded = false } },

    { type = "butcher", name = "Armadillo Butcher",
      coords = vec3(-3691.24, -2621.06, -13.66), heading = 3.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(-3691.32, -2622.97, -14.68),
              heading = 2.6, grounded = false } },

    { type = "butcher", name = "Annesburg Butcher",
      coords = vec3(2932.56, 1302.15, 44.55),   heading = 68.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(2934.49, 1301.58, 43.55),
              heading = 67.8, grounded = false } },

    { type = "butcher", name = "Tumbleweed Butcher",
      coords = vec3(-5508.30, -2948.27, -1.80), heading = 255.0,
      npc = { model = "S_M_M_UNIBUTCHERS_01", coords = vec3(-5509.96, -2947.11, -2.82),
              heading = 255.3, grounded = false } },

    -- ─── DOCTORS ───────────────────────────────────────────────────────────
    { type = "doctor", name = "Valentine Doctor",
      coords = vec3(-286.24, 804.94, 119.46),   heading = 180.0,
      npc = false },

    { type = "doctor", name = "Rhodes Doctor",
      coords = vec3(1369.74, -1308.37, 78.04),  heading = 120.0,
      npc = false },

    { type = "doctor", name = "Saint Denis Doctor",
      coords = vec3(2718.54, -1233.32, 50.44),  heading = 0.0,
      npc = false },

    { type = "doctor", name = "Blackwater Doctor",
      coords = vec3(-788.21, -1304.51, 43.77),  heading = 90.0,
      npc = false },

    { type = "doctor", name = "Strawberry Doctor",
      coords = vec3(-1804.37, -429.72, 158.90), heading = 76.0,
      npc = false },

    { type = "doctor", name = "Armadillo Doctor",
      coords = vec3(-3731.53, -2634.82, -12.79), heading = 267.0,
      npc = false },

    { type = "doctor", name = "Annesburg Doctor",
      coords = vec3(2924.28, 1351.98, 44.83),   heading = 220.0,
      npc = false },

    -- ─── FISH MARKETS ──────────────────────────────────────────────────────
    { type = "fishmarket", name = "Blackwater Fish Market",
      coords = vec3(-762.65, -1359.54, 43.71),  heading = 96.0,
      npc = false },

    { type = "fishmarket", name = "Saint Denis Fish Market",
      coords = vec3(2663.85, -1505.82, 45.97),  heading = 2.0,
      npc = { model = "mp_dr_u_f_m_MISSINGFISHERMAN_01", coords = vec3(2663.89, -1505.70, 44.97),
              heading = 2.1, grounded = false } },

    { type = "fishmarket", name = "Annesburg Fish Market",
      coords = vec3(2983.96, 1402.61, 44.19),   heading = 112.0,
      npc = { model = "mp_dr_u_f_m_MISSINGFISHERMAN_01", coords = vec3(2983.96, 1402.61, 43.19),
              heading = 112.5, grounded = false } },

    -- ─── LUMBER YARDS ──────────────────────────────────────────────────────
    { type = "lumber", name = "Blackwater Lumber Yard",
      coords = vec3(-856.30, -1290.81, 43.44),  heading = 8.0,
      npc = { model = "s_m_m_strlumberjack_01", coords = vec3(-856.30, -1290.81, 42.44),
              heading = 8.0, grounded = false } },

    { type = "lumber", name = "Saint Denis Lumber Yard",
      coords = vec3(2744.13, -1486.52, 45.40),  heading = 7.0,
      npc = { model = "s_m_m_strlumberjack_01", coords = vec3(2744.13, -1486.52, 44.40),
              heading = 7.4, grounded = false } },

    { type = "lumber", name = "Valentine Lumber Yard",
      coords = vec3(-297.32, 739.06, 117.62),   heading = 302.0,
      npc = { model = "s_m_m_strlumberjack_01", coords = vec3(-297.32, 739.06, 116.62),
              heading = 301.9, grounded = false } },

    { type = "lumber", name = "Strawberry Lumber Yard",
      coords = vec3(-1824.27, -426.06, 159.95), heading = 76.0,
      npc = { model = "s_m_m_strlumberjack_01", coords = vec3(-1824.27, -426.06, 158.95),
              heading = 76.4, grounded = false } },

    { type = "lumber", name = "Rhodes Lumber Yard",
      coords = vec3(1377.04, -1275.99, 77.50),  heading = 226.0,
      npc = { model = "s_m_m_strlumberjack_01", coords = vec3(1377.04, -1275.99, 76.50),
              heading = 225.8, grounded = false } },

    { type = "lumber", name = "Armadillo Lumber Yard",
      coords = vec3(-3726.09, -2621.59, -13.30), heading = 267.0,
      npc = { model = "s_m_m_strlumberjack_01", coords = vec3(-3726.09, -2621.59, -14.30),
              heading = 267.5, grounded = false } },

    -- ─── CAMP OUTFITTERS ───────────────────────────────────────────────────
    { type = "outfitter", name = "Valentine Camp Outfitter",
      coords = vec3(-362.79, 721.18, 116.36),   heading = 32.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(-362.79, 721.18, 115.36),
              heading = 32.0, grounded = false } },

    { type = "outfitter", name = "Rhodes Camp Outfitter",
      coords = vec3(1324.06, -1333.94, 77.45),  heading = 180.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(1324.06, -1333.94, 76.45),
              heading = 180.4, grounded = false } },

    { type = "outfitter", name = "Blackwater Camp Outfitter",
      coords = vec3(-946.69, -1387.32, 50.64),  heading = 294.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(-946.69, -1387.32, 49.64),
              heading = 294.5, grounded = false } },

    { type = "outfitter", name = "Strawberry Camp Outfitter",
      coords = vec3(-1767.73, -431.58, 155.27), heading = 105.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(-1767.73, -431.58, 154.27),
              heading = 105.4, grounded = false } },

    { type = "outfitter", name = "Armadillo Camp Outfitter",
      coords = vec3(-3689.85, -2553.15, -13.57), heading = 2.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(-3689.85, -2553.15, -14.57),
              heading = 2.3, grounded = false } },

    { type = "outfitter", name = "Annesburg Camp Outfitter",
      coords = vec3(2976.86, 1429.50, 44.71),   heading = 221.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(2976.86, 1429.50, 43.71),
              heading = 221.3, grounded = false } },

    { type = "outfitter", name = "Tumbleweed Camp Outfitter",
      coords = vec3(-5488.93, -2869.91, -5.01), heading = 7.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(-5488.93, -2869.91, -6.01),
              heading = 7.5, grounded = false } },

    { type = "outfitter", name = "Colter Camp Outfitter",
      coords = vec3(-1336.81, 2405.63, 307.25), heading = 343.0,
      npc = { model = "re_beartrap_males_01", coords = vec3(-1336.81, 2405.63, 306.25),
    ...
    --    coords      = vec3(-311.62, 803.63, 119.39),
    --    heading     = 180.0,
    --    blip        = true,
