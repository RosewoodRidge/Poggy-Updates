...
PM.Locale = {
    ...
    admin_bad_balance      = "Enter a balance of 0 or more.",
    admin_ledger_same      = "The ledger already holds that amount.",

    -- ── Handing a shop over (Config.Transfers) ─────────────────────────────
    transfer_off           = "Shops can only be given to a new owner by staff.",
    transfer_not_owner     = "Only the shop's owner can hand it over.",
    transfer_repo          = "A repossessed shop cannot be handed over.",
    transfer_no_player     = "That player is not here any more.",
    transfer_self          = "You already own this shop.",
    transfer_too_far       = "They need to be standing near you.",
    transfer_max           = "They already own as many shops as they are allowed.",
    transfer_needs_job     = "This shop can only go to someone with the job: %s.",
    transfer_name_mismatch = "Type the shop's name exactly to confirm.",
    transfer_pending       = "There is already an offer out for this shop. Wait for an answer.",
    transfer_ask_title     = "Take over a shop?",
    transfer_ask_text      = "%s wants to give you %s. It has %s in its ledger, %s items in stock and %s staff. It becomes yours, rent included.",
    transfer_sent          = "Offer sent to %s. They have a minute to accept.",
    transfer_declined_you  = "You turned the shop down.",
    transfer_declined      = "%s turned the shop down.",
    transfer_expired       = "The shop offer ran out of time.",
    transfer_failed        = "The handover could not be completed.",
    transfer_received      = "You now own %s.",
    transfer_done          = "%s now belongs to %s.",
