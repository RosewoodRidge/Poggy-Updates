...
-- Admin access
--
-- ACE is checked first. In server.cfg:
--     add_ace group.admin character_storage.admin allow
--
-- Config.AdminGroups is checked after it, against the character's group as
-- poggy_core reports it (perms.group). Existing VORP setups keep working.
-- ============================================================================
Config.AdminAce = 'character_storage.admin'
...
Config.ArmoryShops = {
    {
        ...
        joblock    = {"police", "sheriff", "marshal"}, -- exact job names (case-sensitive)
        showblip   = true,
        npc = {
            model    = "MP_U_M_O_BlWPoliceChief_01",
        ...
        discord = {
            ...
            activity_message_id = "",   -- After first run, copy the ID from server console and paste here as a string
...
Config.DefaultStorages = {
    {
        ...
        locations = {
            ...
            vector3(2490.32, -1315.44, 44.33),    -- St. Denis Police Station
        ...
        authorized_jobs = {
            -- Exact job names from your jobs table (case-sensitive)
            ["police"] = { all_grades = true },
            ["sheriff"] = { all_grades = true },
            ["marshal"] = { all_grades = true },
        },
        ...
        discord = {
            enabled = false,            -- set to true after pasting your webhook URL below
            webhook = "YOUR DISCORD WEBHOOK HERE",
            inventory_message_id = "",  -- After first run, copy the ID from server console and paste here as a string
            activity_message_id = "",   -- After first run, copy the ID from server console and paste here as a string
            update_interval = 600,      -- How often (in seconds) to refresh the inventory summary (600 = 10 minutes)
        },
    },
    {
